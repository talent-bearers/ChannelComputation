...
object ClientUtil {
    ...
    fun renderFluidCuboid(fluid: FluidStack, pos: BlockPos, x1: Double, y1: Double, z1: Double, x2: Double, y2: Double, z2: Double, color: Int) {
        ...
        val brightness = Minecraft.getMinecraft().theWorld.getCombinedLight(pos, fluid.fluid.luminosity)
    ...
    fun putTexturedQuad(renderer: VertexBuffer, sprite: TextureAtlasSprite, x: Double, y: Double, z: Double, w: Double, h: Double, d: Double, face: EnumFacing, color: Int, brightness: Int, flowing: Boolean) {
    ...
    fun putTexturedQuad(renderer: VertexBuffer, sprite: TextureAtlasSprite?, x: Double, y: Double, z: Double, w: Double, h: Double, d: Double, face: EnumFacing, r: Int, g: Int, b: Int, a: Int, light1: Int, light2: Int, flowing: Boolean) {
        if (sprite == null) {
            return
        }
