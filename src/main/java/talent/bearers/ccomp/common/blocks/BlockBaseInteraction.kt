...
abstract class BlockBaseInteraction(name: String) : BlockMod(name, Material.IRON), IDataNode, IModelGenerator {
    companion object {
        ...
        val UP_AABB    = AxisAlignedBB(5 / 16.0, 8 / 16.0, 5 / 16.0, 11 / 16.0,      1.0, 11 / 16.0)
        val DOWN_AABB  = AxisAlignedBB(5 / 16.0,      0.0, 5 / 16.0, 11 / 16.0, 8 / 16.0, 11 / 16.0)

        val SOUTH_AABB = AxisAlignedBB(5 / 16.0, 5 / 16.0, 8 / 16.0, 11 / 16.0, 11 / 16.0,      1.0)
        val NORTH_AABB = AxisAlignedBB(5 / 16.0, 5 / 16.0,      0.0, 11 / 16.0, 11 / 16.0, 8 / 16.0)

        val EAST_AABB  = AxisAlignedBB(8 / 16.0, 5 / 16.0, 5 / 16.0,      1.0, 11 / 16.0, 11 / 16.0)
        val WEST_AABB  = AxisAlignedBB(     0.0, 5 / 16.0, 5 / 16.0, 8 / 16.0, 11 / 16.0, 11 / 16.0)
